...
public class CovidAppointmentNewUI {
    ...
    public CovidAppointmentNewUI(PCDriver loginPage) {
    ...
    public void patientNameCovidForm(String patient) {
        ...
        Assert.assertTrue(checkedWebElementDisplayed(headerCovidForm) && patientName.getText().contains(patient) && !(patientMobile.getText().contains("NA") || patientMobile.getText().contains("null")));
    }
    ...
    public void greenFlag() {
        Assert.assertTrue(lowProbability.getAttribute("class").contains("active"));
    }
